<div class="modal fade" tabindex="-1" id="modalAydee" aria-labelledby="modalAydeeLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Aydee Footwear</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p class="p-2 text-secondary fw-normal fs-6">Es un sistema web con la capacidad de administrar la información de pedidos, 
                    usuarios, procesos productivos, actividades de procesos productivos, encargos especiales, agenda de actividades, así 
                    como el envió de notificaciones en tiempo real a los usuario sobre sus actividades pendientes o subsecuentes, así como 
