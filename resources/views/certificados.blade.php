        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="container-fluid row">
                    <div class="col-lg-6">
                        <img src="{{ asset('media/img/sitce.png') }}" alt="Imagen 1 SETE" class="container p-2 shadow">
                    </div>
                    <div class="col-lg-6">
                        <img src="{{ asset('media/img/sitce02.png') }}" alt="Imagen 2 SETE" class="container p-2 shadow">
                    </div>
                    <div class="col-lg-6">
                        <img src="{{ asset('media/img/sitce03.png') }}" alt="Imagen 1 SETE" class="container p-2 shadow">
                    </div>
                    <div class="col-lg-6">
                        <img src="{{ asset('media/img/sitce04.png') }}" alt="Imagen 1 SETE" class="container p-2 shadow">
                    </div>
                </div>
