<div class="modal fade" tabindex="-1" id="modalCertificados" aria-labelledby="modalCertificadosLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Certificados Electrónicos</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p class="p-2 text-secondary fw-normal fs-6">Es un sistema web con la capacidad de administrar la información alumnos 
                    egresados, responsables de firma, planes de estudio, asignaturas, así como archivar y descifrar firmas electrónicas; con las cuales 
                    se realiza el sellado/firmado de los archivos XML que posteriormente se crean y descargan para tramitar el certificado electrónico 
                    de los egresados de la institución educativa privada. El desarrollo fue totalmente a la medida y en 
                    coordinación con el personal de control escolar del <b>Colegio de San Francisco</b>. Actualmente se tiene planeado realizar una 
                    actualización debido a publicación de la SEP relacionada con el manejo de dichos archivos XML.
                </p>
                <div class="carousel slide mb-6 pointer-event" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{ asset('media/img/sitce.png') }}" alt="Imagen 1 SETE" class="bd-placeholder-img shadow rounded" aria-hideden="true" width="100%" height="auto" preserveAspectRadio="xMidYMid slice" focusable="false">
                        </div>
                        <div class="carousel-item ">
                            <img src="{{ asset('media/img/sitce01.png') }}" alt="Imagen 1 SETE" class="bd-placeholder-img shadow rounded" aria-hideden="true" width="100%" height="auto" preserveAspectRadio="xMidYMid slice" focusable="false">    
                        </div>
                        <div class="carousel-item ">
                            <img src="{{ asset('media/img/sitce02.png') }}" alt="Imagen 1 SETE" class="bd-placeholder-img shadow rounded" aria-hideden="true" width="100%" height="auto" preserveAspectRadio="xMidYMid slice" focusable="false">    
                        </div>
                        <div class="carousel-item ">
                            <img src="{{ asset('media/img/sitce03.png') }}" alt="Imagen 1 SETE" class="bd-placeholder-img shadow rounded" aria-hideden="true" width="100%" height="auto" preserveAspectRadio="xMidYMid slice" focusable="false">    
                        </div>
                        <div class="carousel-item ">
                            <img src="{{ asset('media/img/sitce04.png') }}" alt="Imagen 1 SETE" class="bd-placeholder-img shadow rounded" aria-hideden="true" width="100%" height="auto" preserveAspectRadio="xMidYMid slice" focusable="false">    
                        </div>
                    </div>
                </div>
                ...
                <a href="https://sitce.pabloprogramador.com.mx" class="btn btn-primary d-block w-50 m-auto my-5" role="button" target="_blank">Versión de Demostración</a>
