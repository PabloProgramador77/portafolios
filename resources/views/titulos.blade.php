<div class="modal fade" tabindex="-1" id="modalTitulos" aria-labelledby="modalTitulosLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Titulos Electrónicos</h5>
            ...
            <div class="modal-body">
                <p class="p-2 text-secondary fw-normal fs-6">Es un sistema web con la capacidad de administrar la información de alumnos 
                    egresados, responsables de firma, planes de estudio, así como archivar y descifrar firmas electrónicas; con las cuales 
                    se realiza el sellado/firmado de los archivos XML que posteriormente se crean y descargan para tramitar el título y 
                    cédula electrónica de los egresados de la institución educativa privada. El desarrollo fue totalmente a la medida y en 
                    coordinación con el personal de control escolar del <b>Colegio de San Francisco</b>. El proyecto fue con el acronimo SETE 
                ...
                <div class="carousel slide mb-6 pointer-event" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{ asset('media/img/sete01.png') }}" alt="Imagen 1 SETE" class="bd-placeholder-img shadow rounded" aria-hideden="true" width="100%" height="auto" preserveAspectRadio="xMidYMid slice" focusable="false">
                        </div>
                        <div class="carousel-item ">
                            <img src="{{ asset('media/img/sete02.png') }}" alt="Imagen 1 SETE" class="bd-placeholder-img shadow rounded" aria-hideden="true" width="100%" height="auto" preserveAspectRadio="xMidYMid slice" focusable="false">    
                        </div>
                        <div class="carousel-item ">
                            <img src="{{ asset('media/img/sete03.png') }}" alt="Imagen 1 SETE" class="bd-placeholder-img shadow rounded" aria-hideden="true" width="100%" height="auto" preserveAspectRadio="xMidYMid slice" focusable="false">    
                        </div>
                        <div class="carousel-item ">
                            <img src="{{ asset('media/img/sete04.png') }}" alt="Imagen 1 SETE" class="bd-placeholder-img shadow rounded" aria-hideden="true" width="100%" height="auto" preserveAspectRadio="xMidYMid slice" focusable="false">    
                        </div>
                        <div class="carousel-item ">
                            <img src="{{ asset('media/img/sete05.png') }}" alt="Imagen 1 SETE" class="bd-placeholder-img shadow rounded" aria-hideden="true" width="100%" height="auto" preserveAspectRadio="xMidYMid slice" focusable="false">    
                        </div>
                        <div class="carousel-item ">
                            <img src="{{ asset('media/img/sete06.png') }}" alt="Imagen 1 SETE" class="bd-placeholder-img shadow rounded" aria-hideden="true" width="100%" height="auto" preserveAspectRadio="xMidYMid slice" focusable="false">    
                        </div>
                    </div>
                </div>
