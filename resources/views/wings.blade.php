<div class="modal fade" tabindex="-1" id="modalWings" aria-labelledby="modalWingsLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Wings Mania</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p class="p-2 text-secondary fw-normal fs-6">Es un sistema web con la capacidad de administrar la información de platillos
                    insumos, pedidos, usuarios, descuentos, cortes de caja, impresión de comandas en cocina, tickets de pago y otras 
                    características más. El desarrollo fue totalmente a la medida y en coordinación con el personal y propietario de 
