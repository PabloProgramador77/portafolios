<div class="modal fade" tabindex="-1" id="modalWingsMania" aria-labelledby="modalWingsLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Wings Mania Delivery</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p class="p-2 text-secondary fw-normal fs-6">Es un sistema web con la capacidad de administrar principalmente la información de platillos
                    y pedidos a domicilio y pickup de los clientes de restaurante. El desarrollo fue totalmente a la medida y en coordinación con el personal y propietario de 
                    <b>Wings Mania</b>. Actualmente se encuentra bajo constante mantenimiento y actualización por petición del propietario. Es adaptable a cualquier tamaño de pantalla.
                </p>
                <div class="carousel slide mb-6 pointer-event" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{ asset('media/img/wingsmaniapp01.png') }}" alt="Imagen 1 SETE" class="bd-placeholder-img shadow rounded" aria-hideden="true" width="100%" height="auto" preserveAspectRadio="xMidYMid slice" focusable="false">
                        </div>
                        <div class="carousel-item ">
                            <img src="{{ asset('media/img/wingsmaniapp02.png') }}" alt="Imagen 1 SETE" class="bd-placeholder-img shadow rounded" aria-hideden="true" width="100%" height="auto" preserveAspectRadio="xMidYMid slice" focusable="false">    
                        </div>
                        <div class="carousel-item ">
                            <img src="{{ asset('media/img/wingsmaniapp03.png') }}" alt="Imagen 1 SETE" class="bd-placeholder-img shadow rounded" aria-hideden="true" width="100%" height="auto" preserveAspectRadio="xMidYMid slice" focusable="false">    
                        </div>
                        <div class="carousel-item ">
                            <img src="{{ asset('media/img/wingsmaniapp04.png') }}" alt="Imagen 1 SETE" class="bd-placeholder-img shadow rounded" aria-hideden="true" width="100%" height="auto" preserveAspectRadio="xMidYMid slice" focusable="false">    
                        </div>
                        <div class="carousel-item ">
                            <img src="{{ asset('media/img/wingsmaniapp05.png') }}" alt="Imagen 1 SETE" class="bd-placeholder-img shadow rounded" aria-hideden="true" width="100%" height="auto" preserveAspectRadio="xMidYMid slice" focusable="false">    
                        </div>
                        <div class="carousel-item ">
                            <img src="{{ asset('media/img/wingsmaniapp06.png') }}" alt="Imagen 1 SETE" class="bd-placeholder-img shadow rounded" aria-hideden="true" width="100%" height="auto" preserveAspectRadio="xMidYMid slice" focusable="false">    
                        </div>
                    </div>
                </div>
                <div class="container-fluid p-2">
                    ...
                    <div class="container row">
                        ...
                        <div class="col-lg-4">
                            <p class="p-2 text-secondary fw-normal fs-6 bg-secondary-subtle">Levantamiento de pedidos desde perfil de clientes</p>
                        </div>
                        <div class="col-lg-4">
                            <p class="p-2 text-secondary fw-normal fs-6 bg-secondary-subtle">Perfil de usuarios y clientes</p>
                        </div>
                        <div class="col-lg-4">
                ...
                <a href="https://wingsmaniapp.pabloprogramador.com.mx" class="btn btn-primary d-block w-50 m-auto my-5" role="button" target="_blank">Versión de Demostración</a>
